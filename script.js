...
//     //   });
    ...
    centerPadding: '20px', 
        ...
        prevArrow: "<div class='visible-lg slick-prev'><img src='./img/slider_button_1.png' ></div>",
        nextArrow: "<div class='visible-lg slick-next'><img src='./img/slider_button_1.png' class='rotate'></div>",
        responsive: [
            {
                breakpoint: 1032,
                settings: {
